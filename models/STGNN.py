# Knicked from: <https://github.com/LMissher/STGNN/blob/main/model.py>
...
class Transform(nn.Module):
    def __init__(self, outfea, d):
        ...
        self.ff = nn.Sequential(
            nn.Linear(outfea, outfea), nn.ReLU(), nn.Linear(outfea, outfea)
        )
...
class GRU(nn.Module):
    ...
    def forward(self, x, xh):
        r, u = torch.split(
            torch.sigmoid(self.ff(torch.cat([x, xh], -1))), self.outfea, -1
        )
